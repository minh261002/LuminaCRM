...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $(document).on('change', '.toggle-payment-method-active', function() {
                var isActive = $(this).is(':checked');
                var id = $(this).data('id');
                var checkbox = $(this);
                var label = checkbox.siblings('.label-payment-method-active');
                ...
                $.ajax({
                    url: '{{ route('payment-methods.active', ':id') }}'.replace(':id', id),
                    method: 'PATCH',
                    headers: {
