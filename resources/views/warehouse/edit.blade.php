        ...
        <div class="page-body">
            <div class="container-xl">
                <form action="{{ route('warehouses.update') }}" method="post" class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="branch_id" id="branch_id" class="form-select select2">
                                                ...
                                                @foreach ($branches as $branch)
                                                    <option
                                                        value="{{ $branch->id }}"{{ $model->branch_id == $branch->id ? ' selected' : '' }}>
                    ...
                    <div class="col-md-3">
                        <x-form-button :title="'Thao tác'" :backUrl="route('warehouses.index')" :backText="'Quay lại'" :submitText="'Lưu thay đổi'"
